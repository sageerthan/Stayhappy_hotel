...
import com.project.stayhappy.repository.RoomRepository;
...
public class RoomService implements RoomService_I{
...
//        Blob is more suitable for database storage and retrieval. However, once the data is fetched from the database,
//        converting it to a byte[] makes further manipulation more convenient.
        //Blob photo->byte[] photo->String photo
